...
* [ GeneralException http://ora2pg.darold.net/](http://ora2pg.darold.net/) 
* [ URLError [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:847) http://warp.one/](http://warp.one/) 
* [ URLError [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:847) https://warp.one/](https://warp.one/) 
...
* [Azure Database for PostgreSQL | Microsoft AzureDigitální marketing s využitím Azure Database for PostgreSQLMaloobchodní prodej a elektronické obchodování s využitím Azure Database for PostgreSQLAplikace pro správu financí s využitím Azure Database for PostgreSQLŠkálovatelné webové a mobilní aplikace s využitím Azure Database for PostgreSQLInteligentní aplikace s využitím Azure Database for PostgreSQL](https://azure.microsoft.com/en-us/services/postgresql/) 
...
* [Michael Paquier - PostgreSQL hacker](https://paquier.xyz/) 
