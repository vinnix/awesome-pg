...
* [ 500 http://macpostgresclient.com](http://macpostgresclient.com) 
* [ [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:847) http://warp.one](http://warp.one) 
* [ [SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed (_ssl.c:847) https://warp.one](https://warp.one) 
* [ http://jinchengli.me/post/postgres-query-opt/](http://jinchengli.me/post/postgres-query-opt/) 
...
* [Azure Database for PostgreSQL | Microsoft AzureDigital markedsføring med Azure Database for PostgreSQLRetail and e-commerce using Azure Database for PostgreSQLFinansadministrasjonsapper med Azure Database for PostgreSQLSkalerbare nett- og mobilprogrammer med Azure Database for PostgreSQLIntelligente apper med Azure Database for PostgreSQL](https://azure.microsoft.com/en-us/services/postgresql/) 
...
* [PostreSQL Workload Analyzer — PoWA 3.1.0 documentation](http://powa.readthedocs.io) 
